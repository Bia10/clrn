================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : CypressGUI Project Overview
===============================================================================

The application wizard has created this CypressGUI application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your CypressGUI application.
...
CypressGUI.h
    ...
    CCypressGUIApp application class.

CypressGUI.cpp
    This is the main application source file that contains the application
    class CCypressGUIApp.
...
res\CypressGUI.ico
    ...
    icon is included by the main resource file CypressGUI.rc.
...
CypressGUIDlg.h, CypressGUIDlg.cpp - the dialog
    These files contain your CCypressGUIDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in CypressGUI.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CCypressGUIDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named CypressGUI.pch and a precompiled types file named StdAfx.obj.
