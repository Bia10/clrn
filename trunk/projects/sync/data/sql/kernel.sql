...
insert into settings(module, name, value) values(3, 'log_source', '../logs/DataBase.log');
insert into settings(module, name, value) values(4, 'log_source', '../logs/Network.log');
insert into settings(module, name, value) values(5, 'log_source', '../logs/Common.log');
